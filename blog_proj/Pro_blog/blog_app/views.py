...
# the method get_queryset defines how you can grab list from post.
#__lte= less than or equal to. the - in published_date signifies desc order
...
class DraftListView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        ...
        # here no publication date on the draft_list
